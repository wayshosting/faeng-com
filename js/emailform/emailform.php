...
$formproc->AddRecipient('zulfiqar.shahid@faengineering.com'); //<<---Put your email address here


//2. For better security. Get a random string from this link: http://tinyurl.com/randstr
// and put it here
$formproc->SetFormRandomKey('QBBony8232CUa2I');
...
<div class='container'>
    ...
    <input type='text' name='email' id='email' value='<?php echo $formproc->SafeDisplay('email') ?>' maxlength="100" /><br/>
