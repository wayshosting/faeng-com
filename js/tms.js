...
$.extend(_TMS,{etal:'<div></div>',items:'.items>li',pic:'pic',mask:'mask',paginationCl:'pagination',currCl:'current',pauseCl:'paused',bannerCl:'banner',numStatusCl:'numStatus',pagNums:false,overflow:'hidden',show:0,changeEv:'click',blocksX:1,blocksY:1,preset:'simpleFade',duration:800,easing:'linear',way:'lines',anim:'fade',pagination:true,banners:true,waitBannerAnimation:true,slideshow:false,progressBar:false,pauseOnHover:true,nextBu:true,prevBu:true,playBu:false,preFu:function(){var _=this,img=$(new Image())
...
if(_.banner)
_.banner.appendTo(_.me),_.bannerShow(_.banner)
_.afterAnimation()
_.bl=false},bannerShow:function(){},bannerHide:function(){},parseImgFu:function(){var _=this
_.itms=[]
$(_.items+' img',_.me).each(function(i){_.itms[i]=$(this).attr('src')})},controlsFu:function(){var _=this
if(_.nextBu)
...
_.pags=$('<ul></ul>').addClass(_.paginationCl).appendTo(_.me),$(_.itms).each(function(i){var li=$('<li></li>'),a=$('<a href="#"></a>').text(_.pagNums?i+1:'').appendTo(li).bind(_.changeEv,function(){_.changeFu(i)
return false})
_.pags.append(li)}),_.pags=_.pags.find('li'),_.pags.eq(_.n).addClass(_.currCl)
else
_.pags=$(_.pagination)},startSlShFu:function(prog){var _=this
_.paused=false
_.prog=prog||0
...
_.bannerShow(_.banner=_.banners[_.show].appendTo(_.me))},numStatusChFu:function(){var _=this
...
tmp[i]=clone(obj[i])
return tmp}
$(function(){$('.slider')._TMS({prevBu:'.prev',nextBu:'.next',playBu:'.play',duration:800,pauseOnHover:true,easing:'',pagination:true,slideshow:7000,numStatus:false,reverseWay:false,bannerMeth:'',banners:true,preset:'simpleFade',bannerShow:function(banner){banner.hide().fadeIn(800)},bannerHide:function(banner){banner.show().fadeOut(800)}})})